...
export default function OnlinePage(){
 ...
 {g!.phase==='won'&&<button className="main-action" disabled={busy||!connected||snap.rematch.includes(snap.seat)} onClick={()=>send('rematch')}>{snap.rematch.includes(snap.seat)?'Чекаємо згоди друга':'Зіграти ще раз'}</button>}
